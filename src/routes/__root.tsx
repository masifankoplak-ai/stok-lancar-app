  ...
  head: () => ({
    meta: [
      ...
      { title: "Sahabat UMKM — Stok rapi, jualan lancar." },
      {
        name: "description",
        content:
          "Aplikasi stok dan kasir offline untuk UMKM Indonesia. Catat penjualan, stok, pembelian, dan laba tanpa internet.",
      },
      { name: "author", content: "Sahabat UMKM" },
      { name: "theme-color", content: "#0f766e" },
      { property: "og:title", content: "Sahabat UMKM — Stok rapi, jualan lancar." },
      {
        property: "og:description",
        content: "Catat stok, penjualan, dan laba usaha Anda langsung dari HP, tanpa internet.",
      },
